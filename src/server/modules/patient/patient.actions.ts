...
function revalidatePatientPortal(): void {
    revalidatePath(
        "/patient"
    );
...
function revalidateRelatedAppointmentModules(): void {
    revalidatePatientPortal();
...
export async function updatePatientProfileAction(
    ...
    const parsed =
        PatientUpdateProfileSchema.safeParse(
            {
                phone:
                    String(
                        formData.get(
...
export async function cancelPatientAppointmentAction(
    ...
    try {
        ...
        revalidateRelatedAppointmentModules();
...
export async function reschedulePatientAppointmentAction(
    ...
    try {
        ...
        return {
            ok: true,
            message:
                "La cita se reagendó correctamente.",
        };
    } catch (
    error
    ) {
