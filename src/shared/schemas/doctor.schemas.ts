...
const OptionalAppointmentStatusSchema =
    z.preprocess(
        (value) => {
            if (typeof value !== "string") {
                return undefined;
...
export const DoctorAppointmentStatusSchema =
    z.enum(
        [
            "SCHEDULED",
            "CANCELLED",
...
export const DoctorAgendaFilterSchema =
    z.object({
        date: OptionalDateSchema,
        status:
            OptionalAppointmentStatusSchema,
    });

export const UpsertDoctorScheduleSchema =
    z.object({
        weekday: z.coerce
            .number()
            .int()
...
export const CreateDoctorBlockSchema =
    z.object({
...
export const DeleteDoctorBlockSchema =
    z.object({
        blockId: z
            .string()
            .trim()
...
export const CreateMedicalNoteSchema =
    z.object({
        appointmentId: z
            .string()
            .trim()
        ...
        diagnosis: z
            ...
            .max(
                3000,
                "El diagnóstico no puede superar los 3000 caracteres."
            ),
        treatment: z
            .string()
            .trim()
            .max(
                3000,
                "El tratamiento no puede superar los 3000 caracteres."
            )
            .optional()
            .default(""),
        prescriptionText: z
            ...
            .max(
                3000,
                "La receta no puede superar los 3000 caracteres."
            )
            .optional()
            .default(""),
        instructionsText: z
            ...
            .max(
                3000,
                "Las indicaciones no pueden superar los 3000 caracteres."
            )
            .optional()
            .default(""),
    });
...
export type DoctorAgendaFilterInput =
    z.infer<
...
export type CreateDoctorBlockInput =
    z.infer<
        typeof CreateDoctorBlockSchema
    >;

export type DeleteDoctorBlockInput =
    z.infer<
...
export type CreateMedicalNoteInput =
    z.infer<
        typeof CreateMedicalNoteSchema
    >;